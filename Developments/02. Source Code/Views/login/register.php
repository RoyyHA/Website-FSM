                          ...
                          <div class="row">
	                          <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group">
                                    <label for="FirstName">First Name (<span class="txt_red" style="color: red;">*</span>) </label>
                                    <input type="text" name="Ho" placeholder="" id="FirstName" autofocus="" required>
                                </div>
                               </div>
                               <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group">
                                    <label for="LastName">Last Name (<span class="txt_red" style="color: red;">*</span>) </label>
                                    <input type="text" name="Ten" placeholder="" id="LastName" required>
                                </div>
                               </div>
                               <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group">
                                    <label for="LastName">Username (<span class="txt_red" style="color: red;">*</span>) </label>
                                    <input type="text" name="TaiKhoan" placeholder="" id="LastName" required minlength="5">
                                </div>
                               </div>
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group">
                                    <label for="CustomerEmail">Email  (<span class="txt_red" style="color: red;">*</span>) </label>
                                    <input type="email" name="Email" placeholder="" id="CustomerEmail" class="" autocorrect="off" autocapitalize="off" autofocus="" required>
                                </div>
                            </div>
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                             <div class="form-group">
                                 <label for="LastName">Phone  (<span class="txt_red" style="color: red;">*</span>) </label>
                                 <input type="text" name="SĐT" placeholder="" id="LastName" required pattern="[0-9]+" minlength="10">
                             </div>
                            </div>
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group">
                                    <label for="CustomerPassword">Password  (<span class="txt_red" style="color: red;">*</span>) </label>
                                    <input type="password"  name="Matkhau" placeholder="" id="CustomerPassword" class="" required minlength="6">
                                </div>
                            </div>
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group">
                                    <label for="CustomerPassword">Check Password (<span class="txt_red" style="color: red;">*</span>) </label>
